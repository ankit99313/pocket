...
$showsql ="SELECT * FROM `Civil` where sno='$snoupdate'"; 
...
if(isset($_POST['update'])) // when click on Update button
{
   ...
   $edit=mysqli_query($conn, "UPDATE `Civil` SET `question` = '$questionupdate',`year`='$yearupdate', `semester`='$semesterupdate', `answer`='$answerupdate', `Id`='$questionidupdate' WHERE `Civil`.`sno` = '$snoupdate'");
   ...
   if($edit)
   {
         ...
         window.location.href='/pocket/viewcivil.php';     
         </script>";
