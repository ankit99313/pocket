...
$showsql ="SELECT * FROM `CSE` where sno='$snoupdate'"; 
...
if(isset($_POST['update'])) // when click on Update button
{
   ...
   $edit=mysqli_query($conn, "UPDATE `CSE` SET `question` = '$questionupdate',`year`='$yearupdate', `semester`='$semesterupdate', `answer`='$answerupdate', `Id`='$questionidupdate' WHERE `mechanical`.`sno` = '$snoupdate'");
   ...
   if($edit)
   {
         ...
         window.location.href='/pocket/viewcse.php';     
         </script>";
