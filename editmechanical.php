...
$showsql ="SELECT * FROM `mechanical` where sno='$snoupdate'"; 
...
if(isset($_POST['update'])) // when click on Update button
{
   ...
   $edit=mysqli_query($conn, "UPDATE `mechanical` SET `question` = '$questionupdate',`year`='$yearupdate', `semester`='$semesterupdate', `answer`='$answerupdate', `Id`='$questionidupdate' WHERE `mechanical`.`sno` = '$snoupdate'");
